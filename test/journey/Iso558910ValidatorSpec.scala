...
class Iso558910ValidatorSpec extends BaseSpec:
  ...
  "Iso558910ValidatorSpec" should {
    "reject all non iso8859-15 characters" in
    ...
    "allow all valid characters in iso8859-15" in
